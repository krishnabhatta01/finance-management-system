...
function useSlider({ updateValue: e, updatePosition: t, getDragging: o, formAttrs: n }) {
  ...
  function fe(e2, t2, o2, n2) {
    ...
    const i2 = [hDir("div", { key: "trackC", class: F.value, tabindex: t2.value, ...o2.value }, [h("div", { class: H.value, style: N.value }, l2)], "slide", S.value, () => ie.value)];
    if (false !== a.markerLabels) {
...
var QTabs = createComponent({ name: "QTabs", props: { modelValue: [Number, String], align: { type: String, default: "center", validator: (e) => alignValues$1.includes(e) }, breakpoint: { type: [String, Number], default: 600 }, vertical: Boolean, shrink: Boolean, stretch: Boolean, activeClass: String, activeColor: String, activeBgColor: String, indicatorColor: String, leftIcon: String, rightIcon: String, outsideArrows: Boolean, mobileArrows: Boolean, switchIndicator: Boolean, narrowIndicator: Boolean, inlineLabel: Boolean, noCaps: Boolean, dense: Boolean, contentClass: String, "onUpdate:modelValue": [Function, Array] }, setup(e, { slots: t, emit: o }) {
  ...
  function A({ name: t2, setCurrent: n2, skipEmit: a2 }) {
    m.value !== t2 && (true !== a2 && void 0 !== e["onUpdate:modelValue"] && o("update:modelValue", t2), true !== n2 && void 0 !== e["onUpdate:modelValue"] || (R(m.value, t2), m.value = t2));
  }
  function O() {
    l(() => {
  ...
  function Y(e2) {
    if (u(), true !== C.value && null !== p.value && e2.target && "function" === typeof e2.target.closest) {
      ...
      t2 && true === p.value.contains(t2) && (C.value = true, true === f.value && F(t2));
    }
  }
  function G() {
    s(() => {
...
var QColor = createComponent({ name: "QColor", props: { ...useDarkProps, ...useFormProps, modelValue: String, defaultValue: String, defaultView: { type: String, default: "spectrum", validator: (e) => ["spectrum", "tune", "palette"].includes(e) }, formatModel: { type: String, default: "auto", validator: (e) => ["auto", "hex", "rgb", "hexa", "rgba"].includes(e) }, palette: Array, noHeader: Boolean, noHeaderTabs: Boolean, noFooter: Boolean, square: Boolean, flat: Boolean, bordered: Boolean, disable: Boolean, readonly: Boolean }, emits: ["update:modelValue", "change"], setup(e, { emit: t }) {
  ...
  function H() {
    const e2 = { ref: i, class: "q-color-picker__spectrum non-selectable relative-position cursor-pointer" + (true !== v.value ? " readonly" : ""), style: C.value, ...true === v.value ? { onClick: R, onMousedown: F } : {} }, t2 = [h("div", { style: { paddingBottom: "100%" } }), h("div", { class: "q-color-picker__spectrum-white absolute-full" }), h("div", { class: "q-color-picker__spectrum-black absolute-full" }), h("div", { class: "absolute", style: x.value }, [void 0 !== p.value.hex ? h("div", { class: "q-color-picker__spectrum-circle" }) : null])], o2 = [h(QSlider, { class: "q-color-picker__hue non-selectable", modelValue: p.value.h, min: 0, max: 360, trackSize: "8px", innerTrackColor: "transparent", selectionColor: "transparent", readonly: true !== v.value, thumbPath, "onUpdate:modelValue": B, ...l("lazyhue", { onChange: (e3) => B(e3, true) }) })];
...
var QDate = createComponent({ name: "QDate", props: { ...useDatetimeProps, ...useFormProps, ...useDarkProps, multiple: Boolean, range: Boolean, title: String, subtitle: String, mask: { default: "YYYY/MM/DD" }, defaultYearMonth: { type: String, validator: yearMonthValidator }, yearsInMonthView: Boolean, events: [Array, Function], eventColor: [String, Function], emitImmediately: Boolean, options: [Array, Function], navigationMinYearMonth: { type: String, validator: yearMonthValidator }, navigationMaxYearMonth: { type: String, validator: yearMonthValidator }, noUnset: Boolean, firstDayOfWeek: [String, Number], todayBtn: Boolean, minimal: Boolean, defaultView: { type: String, default: "Calendar", validator: viewIsValid } }, emits: [...useDatetimeEmits, "rangeStart", "rangeEnd", "navigation"], setup(e, { slots: t, emit: o }) {
  ...
  const p = useFormAttrs(e), v = useFormInject(p), m = ref(null), f = ref(de()), g = ref(u()), b = computed(() => de()), y = computed(() => u()), S = computed(() => c()), w = ref(ve(f.value, g.value)), C = ref(e.defaultView), x = true === a.lang.rtl ? "right" : "left", k = ref(x.value), _ = ref(x.value), q = w.value.year, T = ref(q - q % yearsInterval - (q < 0 ? yearsInterval : 0)), P = ref(null), $ = computed(() => {
  ...
  }), R = computed(() => "persian" === e.calendar ? getDayHash : (e2, t2, o2) => formatDate(new Date(e2.year, e2.month - 1, e2.day, e2.hour, e2.minute, e2.second, e2.millisecond), void 0 === t2 ? f.value : t2, void 0 === o2 ? g.value : o2, e2.year, e2.timezoneOffset)), F = computed(() => A.value.length + O.value.reduce((e2, t2) => e2 + 1 + getDateDiff(L.value(t2.to), L.value(t2.from)), 0)), D = computed(() => {
    ...
    if (0 === F.value)
      return lineStr;
    if (F.value > 1)
      return `${F.value} ${g.value.pluralDay}`;
...
var QDialog = createComponent({ name: "QDialog", inheritAttrs: false, props: { ...useModelToggleProps, ...useTransitionProps, transitionShow: String, transitionHide: String, persistent: Boolean, autoClose: Boolean, allowFocusOutside: Boolean, noEscDismiss: Boolean, noBackdropDismiss: Boolean, noRouteDismiss: Boolean, noRefocus: Boolean, noFocus: Boolean, noShake: Boolean, seamless: Boolean, maximized: Boolean, fullWidth: Boolean, fullHeight: Boolean, square: Boolean, position: { type: String, default: "standard", validator: (e) => "standard" === e || ["top", "bottom", "left", "right"].includes(e) } }, emits: [...useModelToggleEmits, "shake", "click", "escapeKey"], setup(e, { slots: t, emit: o, attrs: n }) {
  ...
  function L(t2) {
    null !== c && (clearTimeout(c), c = null), true !== t2 && true !== i.value || (R(false), true !== e.seamless && (v(false), removeFocusout(z), removeEscapeKey(O))), true !== t2 && (d = null);
  }
  function R(e2) {
...
var QDrawer = createComponent({ name: "QDrawer", inheritAttrs: false, props: { ...useModelToggleProps, ...useDarkProps, side: { type: String, default: "left", validator: (e) => ["left", "right"].includes(e) }, width: { type: Number, default: 300 }, mini: Boolean, miniToOverlay: Boolean, miniWidth: { type: Number, default: 57 }, noMiniAnimation: Boolean, breakpoint: { type: Number, default: 1023 }, showIfAbove: Boolean, behavior: { type: String, validator: (e) => ["default", "desktop", "mobile"].includes(e), default: "default" }, bordered: Boolean, elevated: Boolean, overlay: Boolean, persistent: Boolean, noSwipeOpen: Boolean, noSwipeClose: Boolean, noSwipeBackdrop: Boolean }, emits: [...useModelToggleEmits, "onLayout", "miniState"], setup(e, { slots: t, emit: o, attrs: n }) {
  ...
  return watch(m, (t2) => {
    ...
    const o2 = [];
    true === m.value && (false === e.noSwipeOpen && o2.push(withDirectives(h("div", { key: "open", class: `q-drawer__opener fixed-${e.side}`, "aria-hidden": "true" }), U.value)), o2.push(hDir("div", { ref: "backdrop", class: F.value, style: D.value, "aria-hidden": "true", onClick: x }, void 0, "backdrop", true !== e.noSwipeBackdrop && true === b.value, () => W.value)));
...
var QTooltip = createComponent({ name: "QTooltip", inheritAttrs: false, props: { ...useAnchorProps, ...useModelToggleProps, ...useTransitionProps, maxHeight: { type: String, default: null }, maxWidth: { type: String, default: null }, transitionShow: { default: "jump-down" }, transitionHide: { default: "jump-up" }, anchor: { type: String, default: "bottom middle", validator: validatePosition }, self: { type: String, default: "top middle", validator: validatePosition }, offset: { type: Array, default: () => [14, 14], validator: validateOffset }, scrollTarget: { default: void 0 }, delay: { type: Number, default: 0 }, hideDelay: { type: Number, default: 0 } }, emits: [...useModelToggleEmits], setup(e, { slots: t, emit: o, attrs: n }) {
  let a, l;
  const i = getCurrentInstance(), { proxy: { $q: r } } = i, s = ref(null), u = ref(false), c = computed(() => parsePosition(e.anchor, r.lang.rtl)), d = computed(() => parsePosition(e.self, r.lang.rtl)), p = computed(() => true !== e.persistent), { registerTick: v, removeTick: m } = useTick(), { registerTimeout: f } = useTimeout(), { transitionProps: g, transitionStyle: b } = useTransition(e), { localScrollTarget: y, changeScrollEvent: S, unconfigureScrollTarget: w } = useScrollTarget(e, R), { anchorEl: C, canShow: x, anchorEvents: k } = useAnchor({ showing: u, configureAnchorEl: L }), { show: _, hide: q } = useModelToggle({ showing: u, canShow: x, handleShow: M, handleHide: B, hideOnRouteChange: p, processOnMount: true });
  ...
  function M(t2) {
    T(), v(() => {
      l = new MutationObserver(() => Q()), l.observe(s.value, { attributes: false, childList: true, characterData: true, subtree: true }), Q(), R();
...
var QEditor = createComponent({ name: "QEditor", props: { ...useDarkProps, ...useFullscreenProps, modelValue: { type: String, required: true }, readonly: Boolean, disable: Boolean, minHeight: { type: String, default: "10rem" }, maxHeight: String, height: String, definitions: Object, fonts: Object, placeholder: String, toolbar: { type: Array, validator: (e) => 0 === e.length || e.every((e2) => e2.length), default() {
  ...
  return onMounted(() => {
    ...
    return h("div", { ref: d, class: P.value, style: { height: true === s.value ? "100%" : null }, ...M.value, onFocusin: L, onFocusout: R }, [t2, h("div", { ref: p, style: T.value, class: $.value, contenteditable: f.value, placeholder: e.placeholder, ...{}, ...c.listeners.value, onInput: B, onKeydown: E, onClick: Q, onBlur: A, onFocus: O, onMousedown: F, onTouchstartPassive: F })]);
  };
} });
...
var QInput = createComponent({ name: "QInput", inheritAttrs: false, props: { ...useFieldProps, ...useMaskProps, ...useFormProps, modelValue: { required: false }, shadowText: String, type: { type: String, default: "text" }, debounce: [String, Number], autogrow: Boolean, inputClass: [Array, String, Object], inputStyle: [Array, String, Object] }, emits: [...useFieldEmits, "paste", "change", "keydown", "click", "animationend"], setup(e, { emit: t, attrs: o }) {
  ...
  watch(() => e.type, () => {
    ...
    return h(true === k.value ? "textarea" : "input", { ref: d, class: ["q-field__native q-placeholder", e.inputClass], style: e.inputStyle, ...T.value, ...q.value, ..."file" !== e.type ? { value: R() } : S.value });
  }, getShadowControl: () => {
    return h("div", { class: "q-field__native q-field__shadow absolute-bottom no-pointer-events" + (true === k.value ? "" : " text-no-wrap") }, [h("span", { class: "invisible" }, R()), h("span", e.shadowText)]);
  } });
  const F = useField(x);
  return Object.assign(n, { focus: P, select: $, getNativeElement: () => d.value }), injectProp(n, "nativeEl", () => d.value), F;
} });
...
var QSelect = createComponent({ name: "QSelect", inheritAttrs: false, props: { ...useVirtualScrollProps, ...useFormProps, ...useFieldProps, modelValue: { required: true }, multiple: Boolean, displayValue: [String, Number], displayValueHtml: Boolean, dropdownIcon: String, options: { type: Array, default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], hideSelected: Boolean, hideDropdownIcon: Boolean, fillInput: Boolean, maxValues: [Number, String], optionsDense: Boolean, optionsDark: { type: Boolean, default: null }, optionsSelectedClass: String, optionsHtml: Boolean, optionsCover: Boolean, menuShrink: Boolean, menuAnchor: String, menuSelf: String, menuOffset: Array, popupContentClass: String, popupContentStyle: [String, Array, Object], useInput: Boolean, useChips: Boolean, newValueMode: { type: String, validator: validateNewValueMode }, mapOptions: Boolean, emitValue: Boolean, inputDebounce: { type: [Number, String], default: 500 }, inputClass: [Array, String, Object], inputStyle: [Array, String, Object], tabindex: { type: [String, Number], default: 0 }, autocomplete: String, transitionShow: String, transitionHide: String, transitionDuration: [String, Number], behavior: { type: String, validator: (e) => ["default", "menu", "dialog"].includes(e), default: "default" }, virtualScrollItemSize: { type: [Number, String], default: void 0 }, onNewValue: Function, onFilter: Function }, emits: [...useFieldEmits, "add", "remove", "inputValue", "newValue", "keyup", "keypress", "keydown", "filterAbort"], setup(e, { slots: t, emit: o }) {
  ...
  }), z = computed(() => null === e.optionsDark ? R.isDark.value : e.optionsDark), I = computed(() => fieldValueIsFilled(F.value)), V = computed(() => {
    let t2 = "q-field__input q-placeholder col";
    return true === e.hideSelected || 0 === F.value.length ? [t2, e.inputClass] : (t2 += " q-field__input--padding", void 0 === e.inputClass ? t2 : [t2, e.inputClass]);
  }), H = computed(() => (true === e.virtualScrollHorizontal ? "q-virtual-scroll--horizontal" : "") + (e.popupContentClass ? " " + e.popupContentClass : "")), N = computed(() => 0 === P.value), j = computed(() => F.value.map((e2) => ae.value(e2)).join(", ")), U = computed(() => void 0 !== e.displayValue ? e.displayValue : j.value), K = computed(() => true === e.optionsHtml ? () => true : (e2) => void 0 !== e2 && null !== e2 && true === e2.html), W = computed(() => true === e.displayValueHtml || void 0 === e.displayValue && (true === e.optionsHtml || F.value.some(K.value))), Y = computed(() => true === R.focused.value ? e.tabindex : -1), G = computed(() => {
  ...
  }), X = computed(() => ({ id: `${R.targetUid.value}_lb`, role: "listbox", "aria-multiselectable": true === e.multiple ? "true" : "false" })), Z = computed(() => {
    return F.value.map((e2, t2) => ({ index: t2, opt: e2, html: K.value(e2), selected: true, removeAtIndex: ce, toggleOption: pe, tabindex: Y.value }));
  }), J = computed(() => {
    if (0 === P.value)
      return [];
    const { from: t2, to: o2 } = M.value;
    return e.options.slice(t2, o2).map((o3, n2) => {
      const i2 = true === le.value(o3), s2 = t2 + n2, u2 = { clickable: true, active: false, activeClass: oe.value, manualFocus: true, focused: false, disable: i2, tabindex: -1, dense: e.optionsDense, dark: z.value, role: "option", id: `${R.targetUid.value}_${s2}`, onClick: () => {
        pe(o3);
      } };
  ...
  function pe(t2, n2) {
    if (true !== R.editable.value || void 0 === t2 || true === le.value(t2))
      return;
    const a2 = ne.value(t2);
    if (true !== e.multiple)
      return true !== n2 && (Me(true === e.fillInput ? ae.value(t2) : "", true, true), He()), null !== C.value && C.value.focus(), void (0 !== F.value.length && true === isDeepEqual(ne.value(F.value[0]), a2) || o("update:modelValue", true === e.emitValue ? a2 : t2));
    if ((true !== p || true === u.value) && R.focus(), be(), 0 === F.value.length) {
    ...
    if (void 0 === t2.keyCode)
      if (t2.target.value = "", null !== y && (clearTimeout(y), y = null), Ne(), "string" === typeof o2 && 0 !== o2.length) {
        const t3 = o2.toLocaleLowerCase(), n2 = (o3) => {
          ...
          return void 0 !== n3 && (-1 === F.value.indexOf(n3) ? pe(n3) : He(), true);
        }, a2 = (e2) => {
  ...
  function Ce(t2) {
    ...
    if ((void 0 === g || b < Date.now()) && (g = ""), i2 > 0 && true !== e.useInput && void 0 !== t2.key && 1 === t2.key.length && false === t2.altKey && false === t2.ctrlKey && false === t2.metaKey && (32 !== t2.keyCode || 0 !== g.length)) {
      ...
      if (9 !== t2.keyCode && stopAndPrevent(t2), r.value > -1 && r.value < i2)
        ...
        true === l.value ? Ie() : true !== R.innerLoading.value && Ve();
      }
  }
  function xe() {
  ...
  function _e() {
    return true === e.hideSelected ? [] : void 0 !== t["selected-item"] ? Z.value.map((e2) => t["selected-item"](e2)).slice() : void 0 !== t.selected ? [].concat(t.selected()) : true === e.useChips ? Z.value.map((t2, o2) => h(QChip, { key: "option-" + o2, removable: true === R.editable.value && true !== le.value(t2.opt), dense: true, textColor: e.color, tabindex: Y.value, onRemove() {
      t2.removeAtIndex(o2);
  ...
  function Pe(t2) {
    null !== y && (clearTimeout(y), y = null), t2 && t2.target && true === t2.target.qComposing || ($e(t2.target.value || ""), v = true, m = s.value, true === R.focused.value || true === p && true !== u.value || R.focus(), void 0 !== e.onFilter && (y = setTimeout(() => {
      y = null, Be(s.value);
    }, e.inputDebounce)));
  }
  function $e(e2) {
  ...
  function Be(t2, a2, i2) {
    if (void 0 === e.onFilter || true !== a2 && true !== R.focused.value)
      return;
    true === R.innerLoading.value ? o("filterAbort") : (R.innerLoading.value = true, c.value = true), "" !== t2 && true !== e.multiple && 0 !== F.value.length && true !== v && t2 === ae.value(F.value[0]) && (t2 = "");
    const r2 = setTimeout(() => {
      true === l.value && (l.value = false);
    }, 10);
    null !== S && clearTimeout(S), S = r2, o("filter", t2, (e2, t3) => {
      true !== a2 && true !== R.focused.value || S !== r2 || (clearTimeout(S), "function" === typeof e2 && e2(), c.value = false, nextTick(() => {
        R.innerLoading.value = false, true === R.editable.value && (true === a2 ? true === l.value && He() : true === l.value ? je(true) : l.value = true), "function" === typeof t3 && nextTick(() => {
          t3(n);
      ...
      true === R.focused.value && S === r2 && (clearTimeout(S), R.innerLoading.value = false, c.value = false), true === l.value && (l.value = false);
    });
  }
  function Ee() {
  ...
  function Re() {
    const o2 = [h(QField, { class: `col-auto ${R.fieldClass.value}`, ...D.value, for: R.targetUid.value, dark: z.value, square: true, loading: c.value, itemAligned: false, filled: true, stackLabel: 0 !== s.value.length, ...R.splitAttrs.listeners.value, onFocus: Oe, onBlur: Le }, { ...t, rawControl: () => R.getControl(true), before: void 0, after: void 0 })];
    return true === l.value && o2.push(h("div", { ref: _, class: H.value + " scroll", style: e.popupContentStyle, ...X.value, onClick: prevent, onScrollPassive: A }, qe())), h(QDialog, { ref: k, modelValue: i.value, position: true === e.useInput ? "top" : void 0, transitionShow: f, transitionHide: e.transitionHide, transitionDuration: e.transitionDuration, onBeforeShow: We, onBeforeHide: Fe, onHide: De, onShow: ze }, () => h("div", { class: "q-select__dialog" + (true === z.value ? " q-select__dialog--dark q-dark" : "") + (true === u.value ? " q-select__dialog--focused" : "") }, o2));
  }
  function Fe(e2) {
    Ye(e2), null !== k.value && k.value.__updateRefocusTarget(R.rootRef.value.querySelector(".q-field__native > [tabindex]:last-child")), R.focused.value = false;
  }
  function De(e2) {
    He(), false === R.focused.value && o("blur", e2), Ne();
  }
  function ze() {
    const e2 = document.activeElement;
  ...
  function Ie() {
    true !== i.value && (r.value = -1, true === l.value && (l.value = false), false === R.focused.value && (null !== S && (clearTimeout(S), S = null), true === R.innerLoading.value && (o("filterAbort"), R.innerLoading.value = false, c.value = false)));
  }
  function Ve(o2) {
    true === R.editable.value && (true === p ? (R.onControlFocusin(o2), i.value = true, nextTick(() => {
      R.focus();
    })) : R.focus(), void 0 !== e.onFilter ? Be(s.value) : true === N.value && void 0 === t["no-option"] || (l.value = true));
  }
  function He() {
    i.value = false, Ie();
  }
  function Ne() {
    true === e.useInput && Me(true !== e.multiple && true === e.fillInput && 0 !== F.value.length && ae.value(F.value[0]) || "", true, true);
  }
  function je(t2) {
    let o2 = -1;
    if (true === t2) {
      if (0 !== F.value.length) {
        const t3 = ne.value(F.value[0]);
  ...
  function Ue(e2, t2) {
    true === l.value && false === R.innerLoading.value && (E(-1, true), nextTick(() => {
      true === l.value && false === R.innerLoading.value && (e2 > t2 ? E() : je(true));
    }));
  }
  function Ke() {
  ...
  return watch(F, (t2) => {
    d = t2, true === e.useInput && true === e.fillInput && true !== e.multiple && true !== R.innerLoading.value && (true !== i.value && true !== l.value || true !== I.value) && (true !== v && Ne(), true !== i.value && true !== l.value || Be(""));
  ...
  }, getInnerAppend: () => true !== e.loading && true !== c.value && true !== e.hideDropdownIcon ? [h(QIcon, { class: "q-select__dropdown-icon" + (true === l.value ? " rotate-180" : ""), name: ee.value })] : null }), useField(R);
} });
...
var QTable = createComponent({ name: "QTable", props: { rows: { type: Array, default: () => [] }, rowKey: { type: [String, Function], default: "id" }, columns: Array, loading: Boolean, iconFirstPage: String, iconPrevPage: String, iconNextPage: String, iconLastPage: String, title: String, hideHeader: Boolean, grid: Boolean, gridHeader: Boolean, dense: Boolean, flat: Boolean, bordered: Boolean, square: Boolean, separator: { type: String, default: "horizontal", validator: (e) => ["horizontal", "vertical", "cell", "none"].includes(e) }, wrapCells: Boolean, virtualScroll: Boolean, virtualScrollTarget: { default: void 0 }, ...commonVirtPropsObj, noDataLabel: String, noResultsLabel: String, loadingLabel: String, selectedRowsLabel: Function, rowsPerPageLabel: String, paginationLabel: Function, color: { type: String, default: "grey-8" }, titleClass: [String, Array, Object], tableStyle: [String, Array, Object], tableClass: [String, Array, Object], tableHeaderStyle: [String, Array, Object], tableHeaderClass: [String, Array, Object], cardContainerClass: [String, Array, Object], cardContainerStyle: [String, Array, Object], cardStyle: [String, Array, Object], cardClass: [String, Array, Object], hideBottom: Boolean, hideSelectedBanner: Boolean, hideNoData: Boolean, hidePagination: Boolean, onRowClick: Function, onRowDblclick: Function, onRowContextmenu: Function, ...useDarkProps, ...useFullscreenProps, ...useTableColumnSelectionProps, ...useTableFilterProps, ...useTablePaginationProps, ...useTableRowExpandProps, ...useTableRowSelectionProps, ...useTableSortProps }, emits: ["request", "virtualScroll", ...useFullscreenEmits, ...useTableRowExpandEmits, ...useTableRowSelectionEmits], setup(e, { slots: t, emit: o }) {
  ...
  const { innerPagination: f, computedPagination: g, isServerSide: b, requestServerInteraction: y, setPagination: S } = useTablePaginationState(n, me), { computedFilterMethod: w } = useTableFilter(e, S), { isRowExpanded: C, setExpanded: x, updateExpanded: k } = useTableRowExpand(e, o), _ = computed(() => {
    ...
    return e.filter && (t2 = w.value(t2, e.filter, F.value, me)), null !== I.value && (t2 = V.value(e.rows === t2 ? t2.slice() : t2, o2, n2)), t2;
  ...
  function ae() {
    ...
    if (true === d.value) {
      ...
      if (void 0 !== n3) {
        const e2 = h("tbody", n3({ cols: F.value }));
        l2.before = null === o2 ? () => e2 : () => [o2()].concat(e2);
      } else
        null !== o2 && (l2.before = o2);
      return void 0 !== a2 && (l2.after = () => h("tbody", a2({ cols: F.value }))), h(QVirtualScroll, { ref: c, class: e.tableClass, style: e.tableStyle, ...oe.value, scrollTarget: e.virtualScrollTarget, items: T.value, type: "__qtable", tableColspan: z.value, onVirtualScroll: ie }, l2);
    }
    const n2 = [ue()];
  ...
  function se(n2, a2, i2) {
    ...
    const c2 = t["body-cell"], d2 = F.value.map((e2) => {
  ...
  function ue() {
    ...
    return void 0 !== o2 && (a2 = o2({ cols: F.value }).concat(a2)), void 0 !== n2 && (a2 = a2.concat(n2({ cols: F.value }))), h("tbody", a2);
  }
  function ce(e2) {
  ...
  function ve(t2) {
    Object.assign(t2, { cols: F.value, colsMap: D.value, sort: H, rowIndex: N.value + t2.pageIndex, color: e.color, dark: l.value, dense: e.dense }), true === P.value && injectProp(t2, "selected", () => A(t2.key), (e2, o2) => {
  ...
  function Se(t2) {
    return Object.assign(t2, { cols: F.value, sort: H, colsMap: D.value, color: e.color, dark: l.value, dense: e.dense }), true === M.value && injectProp(t2, "selected", () => ge.value, we), t2;
  }
  function we(e2) {
...
var QTree = createComponent({ name: "QTree", props: { ...useDarkProps, nodes: { type: Array, required: true }, nodeKey: { type: String, required: true }, labelKey: { type: String, default: "label" }, childrenKey: { type: String, default: "children" }, dense: Boolean, color: String, controlColor: String, textColor: String, selectedColor: String, icon: String, tickStrategy: { type: String, default: "none", validator: (e) => tickStrategyOptions.includes(e) }, ticked: Array, expanded: Array, selected: {}, noSelectionUnset: Boolean, defaultExpandAll: Boolean, accordion: Boolean, filter: String, filterMethod: Function, duration: Number, noConnectors: Boolean, noTransition: Boolean, noNodesLabel: String, noResultsLabel: String }, emits: ["update:expanded", "update:ticked", "update:selected", "lazyLoad", "afterShow", "afterHide"], setup(e, { slots: t, emit: o }) {
  ...
  const c = computed(() => `q-tree q-tree--${true === e.dense ? "dense" : "standard"}` + (true === e.noConnectors ? " q-tree--no-connectors" : "") + (true === l.value ? " q-tree--dark" : "") + (void 0 !== e.color ? ` text-${e.color}` : "")), d = computed(() => void 0 !== e.selected), p = computed(() => e.icon || a.iconSet.tree.icon), v = computed(() => e.controlColor || e.color), m = computed(() => void 0 !== e.textColor ? ` text-${e.textColor}` : ""), f = computed(() => {
    ...
    const t2 = {}, o2 = (n2, a2) => {
      const l2 = n2.tickStrategy || (a2 ? a2.tickStrategy : e.tickStrategy), u2 = n2[e.nodeKey], c2 = n2[e.childrenKey] && 0 !== n2[e.childrenKey].length, p2 = true !== n2.disabled && true === d.value && false !== n2.selectable, v2 = true !== n2.disabled && false !== n2.expandable, m2 = "none" !== l2, f2 = "strict" === l2, h2 = "leaf-filtered" === l2, b2 = "leaf" === l2 || "leaf-filtered" === l2;
  ...
  function L(t2, n2, a2, l2) {
    true !== l2 && false !== n2.selectable && O(n2.key), d.value && n2.selectable ? false === e.noSelectionUnset ? o("update:selected", n2.key !== e.selected ? n2.key : null) : n2.key !== e.selected && o("update:selected", void 0 === n2.key ? null : n2.key) : R(t2, n2, a2, l2), "function" === typeof t2.handler && t2.handler(t2);
  }
...
function getRenderer(e) {
  ...
  function A(e2, t2) {
    ...
    0 !== n2.files.length && (v.files.value = l2, t2(n2), a("removed", n2.files));
  }
  function O(e2) {
  ...
  function I() {
    return h("input", { ref: p, class: "q-uploader__input overflow-hidden absolute-full", tabindex: -1, type: "file", title: "", accept: o.accept, multiple: true === o.multiple ? "multiple" : void 0, capture: o.capture, onMousedown: stop, onClick: m, onChange: F });
  }
  function V() {
    return void 0 !== n.header ? n.header(N) : [h("div", { class: "q-uploader__header-content column" }, [h("div", { class: "flex flex-center no-wrap q-gutter-xs" }, [z(0 !== v.queuedFiles.value.length, "removeQueue", Q), z(0 !== v.uploadedFiles.value.length, "removeUploaded", E), true === v.isUploading.value ? h(QSpinner, { class: "q-uploader__spinner" }) : null, h("div", { class: "col column justify-center" }, [void 0 !== o.label ? h("div", { class: "q-uploader__title" }, [o.label]) : null, h("div", { class: "q-uploader__subtitle" }, [q.value + " / " + _.value])]), z(T.value, "add"), z(false === o.hideUploadBtn && true === P.value, "upload", v.upload), z(v.isUploading.value, "clear", v.abort)])])];
  }
  function H() {
  ...
  watch(v.isUploading, (e2, t2) => {
    ...
    true === v.isUploading.value && v.abort(), 0 !== v.files.value.length && L();
  });
  const N = {};
  for (const h2 in v)
...
function morph(e) {
  ...
  const P = () => {
    ...
    const B = () => {
      ...
      a2.insertBefore(Q, A);
      const { borderWidth: O, borderStyle: L, borderColor: R, borderRadius: F, backgroundColor: D, transform: z, position: I, cssText: V } = getComputedStyle$1(e2, ["borderWidth", "borderStyle", "borderColor", "borderRadius", "backgroundColor", "transform", "position", "cssText"]), H = e2.classList.toString(), N = e2.style.cssText;
...
var Quasar = { version: "2.12.0", install(e, t, o) {
